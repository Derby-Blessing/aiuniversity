                      ...
                      <Form>
                        ...
                        <Row>
                          <Col md>
                            <Form.Group
                              as={Col}
                              controlId="formGriddifficulties_transferring"
                            >
                              <Form.Label as="h5">
                                Hai trovato difficoltà nel trasferimento?*
                              </Form.Label>
                            </Form.Group>
                            <Form>
                              {["radio"].map((type) => (
      ...
      (ES: scienze ambientali,matematica,biotecnologie agricole,robotica,game developing,sociologia.....)"
                        ...
                        <Row>
                          ...
                          <Form.Group as={Col} controlId="formGridend_year">
                            <Form.Label as="h5">
                              In che anno prevedi di terminare l’università?*
                            </Form.Label>
                            <Form.Control />
                          </Form.Group>
                        </Row>
                        ...
                        >
                          <Form.Label as="h5">
                            Qual'è l'ASPETTO del tuo corso che ti ha messo più
                            in difficoltà?*
                          </Form.Label>
                          <Form.Control
                            as="textarea"
                        ...
                        <Form.Group as={Col} controlId="formGrideasy_exams">
                          <Form.Label as="h5">
                            Quali sono stati, finora, gli ESAMI che hai trovato
                            più FACILI?*
                          </Form.Label>
                          <Form.Control
                            as="textarea"
                        ...
                        <Row>
                          ...
                          <Col md>
                            <Form.Group
                              as={Col}
                              controlId="formGridreason_redo_choice"
                            >
                        ...
                        <Row>
                          <Form.Group
                            as={Col}
                            controlId="formGriddecision_choice"
                          >
                            <Form.Label as="h5">
                              Cosa/Chi ti ha spinto a fare questa scelta?*
                            </Form.Label>
                            <Form.Control />
                          </Form.Group>
                        ...
                        <Row>
                          <Col md>
                            <Form.Group
                              as={Col}
                              controlId="formGridexpectations_met"
                            >
                              <Form.Label as="h5">
                                Finora, sono state soddisfatte le tue
                                aspettative? *
                              </Form.Label>
                            </Form.Group>
                            <Form>
                          ...
                          <Col md>
                            <Form.Group
                              as={Col}
                              controlId="formGridexpectations_no"
                            >
                        ...
                        <Row>
                          ...
                          <Col md>
                            <Form.Group
                              className="mb-3"
                              controlId="prev_change_uni"
                            >
                              <Form.Label as="h5">
                                Qual'era la tua precedente UNIVERSITA'?*
                              </Form.Label>
                              <Universities></Universities>
                            </Form.Group>
                          </Col>
                        ...
                        <Row>
                          <Col md>
                            <Form.Group
                              className="mb-3"
                              controlId="select_triennial"
                            >
                              <Form.Label as="h5">
                                Che università hai frequentato alla triennale?*
                              </Form.Label>
                              <Universities></Universities>
                            </Form.Group>
                          </Col>
                          <Col md>
                            <Form.Group
                              className="mb-3"
                              controlId="prev_change_department"
                            >
                              <Form.Label as="h5">
                                Qual'era la tua precedente FACOLTA'?*
                              </Form.Label>
                              <Form.Control />
                            </Form.Group>
                          </Col>
                        ...
                        <Row>
                          <Col md>
                            <Form.Group
                              className="mb-3"
                              controlId="prev_change_degree_course"
                            >
                              <Form.Label as="h5">
                                Qual'era il tuo precedente CORSO DI LAUREA?*
                              </Form.Label>
                              <Form.Control />
                            </Form.Group>
                          </Col>
                        ...
                        <Row>
                          <Col md>
                            <Form.Group
                              as={Col}
                              controlId="formGridtriennial_university_type"
                            >
                              <Form.Label as="h5">
                                Che tipo di università era?*
                              </Form.Label>
                            </Form.Group>
                            <Form>
                              {["radio"].map((type) => (
                          ...
                          <Col md>
                            <Form.Group
                              className="mb-3"
                              controlId="triennial_department"
                            >
                              <Form.Label as="h5">
                        ...
                        <Row>
                          <Col md>
                            <Form.Group
                              className="mb-3"
                              controlId="formGridtriennial_course_degree"
                            >
                              <Form.Label as="h5">
                                Che corso di laurea hai fatto?*
                              </Form.Label>
                              <Form.Control />
                            </Form.Group>
                          </Col>
                          <Col md>
                            <Form.Group
                              className="mb-3"
                              controlId="formGridtriennial_enrolment_year"
                            >
                              <Form.Label as="h5">
                                In che anno ti eri iscritto?*
                              </Form.Label>
                              <Form.Control />
                            </Form.Group>
                          </Col>
                        ...
                        <Col md>
                          <Form.Group
                            className="mb-3"
                            controlId="formGridtriennial_subject_area"
                          >
                            <Form.Label as="h5">
                              Quali erano le discipline principali del tuo
                              VECCHIO corso?*
                            </Form.Label>
                            <Form.Control
                              as="textarea"
      ...
      (ES: scienze ambientali,matematica,biotecnologie agricole,robotica,game developing,sociologia.....)"
                        ...
                        <Row>
                          <Col md>
                            <Form.Group
                              className="mb-3"
                              controlId="formGridtriennial_end_year"
                            >
                              <Form.Label as="h5">
                        ...
                        <Row>
                          <Col md>
                            ...
                            >
                              <Form.Label as="h5">
                                Hai scelto una magistrale inerente ai tuoi studi
                                passati?*
                              </Form.Label>
                            </Form.Group>
                            <Form>
                          ...
                          <Col md>
                            <Form.Group
                              className="mb-3"
                              controlId="formGridtriennial_grade"
                            >
                              <Form.Label as="h5">
                                Con che voto di laurea sei uscito?*
                              </Form.Label>
                        ...
                        <Row>
                          <Col md>
                            <Form.Group
                              as={Col}
                              controlId="formGridwork_experience"
                            >
                              <Form.Label as="h5">
                                Hai avuto esperienze lavorative durante gli
                                studi?*
                              </Form.Label>
                            </Form.Group>
                            <Form>
                          ...
                          <Col md>
                            <Form.Group
                              className="mb-3"
                              controlId="formGridwork_experience_type"
                            >
                              <Form.Label as="h5">
                                Che tipo di esperienza/e lavorativa/e?*
                              </Form.Label>
                              <Form.Control as="textarea" />
                            </Form.Group>
                          </Col>
                        ...
                        <Row>
                          <Col md>
                            <Form.Group
                              as={Col}
                              controlId="formGridwork_related_studies"
                            >
                              <Form.Label as="h5">
                                E' stata inerente al corso di studi?*
                              </Form.Label>
                            </Form.Group>
                            <Form>
                              {["radio"].map((type) => (
                          ...
                          <Col md>
                            <Form.Group
                              className="mb-3"
                              controlId="formGridyear_start_work"
                            >
                              <Form.Label as="h5">
                                In che ANNO di LAUREA hai iniziato a lavorare?*
                              </Form.Label>
                              <Form.Control />
                            </Form.Group>
                          </Col>
