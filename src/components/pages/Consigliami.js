                      ...
                      <Form>
                        ...
                        <Row>
                          <Col md>
                            <Form.Group
                              as={Col}
                              controlId="formGridExpectations"
                            >
                              <Form.Label>
                                Quali sono le tue aspettative sull'università?
                              </Form.Label>
                              <Form.Control as="textarea" />
                            </Form.Group>
                          </Col>
                        ...
                        <Row>
                          <Col md>
                            <Form.Group as={Col} controlId="formGridMotives">
                              <Form.Label>
                                Quali sono i motivi della tua scelta?
                              </Form.Label>
                              <Form.Control as="textarea" />
                            </Form.Group>
                          </Col>
                        ...
                        <Row>
                          <Col md>
                            <Form.Group
                              as={Col}
                              controlId="formGridPrevStudies"
                            >
                              <Form.Label>
                                Ti piacerebbe continuare con i tuoi studi
                                precedenti?
                              </Form.Label>
                              <Form.Control />
                            </Form.Group>
